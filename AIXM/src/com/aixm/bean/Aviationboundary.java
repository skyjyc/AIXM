...
/**
 * Aviationboundary entity. @author MyEclipse Persistence Tools
 */

public class Aviationboundary implements java.io.Serializable {
	...
	/** default constructor */
	public Aviationboundary() {
	}

	/** minimal constructor */
	public Aviationboundary(String designator) {
		this.designator = designator;
	}

	/** full constructor */
	public Aviationboundary(String designator, String elevationValue, String elevationUom, String elevationNilReason,
