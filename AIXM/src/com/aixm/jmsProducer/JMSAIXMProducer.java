...
public class JMSAIXMProducer {
    ...
    public void producer() throws JMSException{
         ...
         // 实例化连接工厂  
         connectionFactory = new ActiveMQConnectionFactory(JMSAIXMProducer.USERNAME, JMSAIXMProducer.PASSWORD,  
        		 JMSAIXMProducer.BROKEURL);  
         ...
         try {  
             ...
             destination = session.createTopic("AirportHeliport");// 创建消息队列  
