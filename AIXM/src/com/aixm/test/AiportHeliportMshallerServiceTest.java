package com.aixm.test;
import com.aixm.jmsProducer.JMSAIXMProducer;
...
import com.aixm.bean.Airportheliport;
import com.aixm.bean.AirportheliportDAO;
import com.aixm.bean.Arp;
import com.aixm.bean.ArpDAO;
import com.aixm.bean.Availability;
import com.aixm.bean.AvailabilityDAO;
import com.aixm.bean.Aviationboundary;
import com.aixm.bean.AviationboundaryDAO;
import com.aixm.bean.Contact;
import com.aixm.bean.ContactDAO;
import com.aixm.bean.Responsibleorganisation;
import com.aixm.bean.ResponsibleorganisationDAO;
import com.aixm.bean.Servedcity;
import com.aixm.bean.ServedcityDAO;
import com.cfar.swim.aixm.bind.AixmMarshaller;

import aero.aixm.AirportHeliportAvailabilityPropertyType;
import aero.aixm.AirportHeliportAvailabilityType;
import aero.aixm.AirportHeliportResponsibilityOrganisationPropertyType;
import aero.aixm.AirportHeliportResponsibilityOrganisationType;
import aero.aixm.AirportHeliportTimeSlicePropertyType;
import aero.aixm.AirportHeliportTimeSliceType;
import aero.aixm.AirportHeliportType;
import aero.aixm.AirportHeliportUsagePropertyType;
import aero.aixm.AirportHeliportUsageType;
import aero.aixm.CityPropertyType;
import aero.aixm.CityType;
import aero.aixm.CodeAirportHeliportDesignatorType;
import aero.aixm.CodeAirportHeliportType;
import aero.aixm.CodeAirportWarningType;
import aero.aixm.CodeAuthorityRoleType;
import aero.aixm.CodeIATAType;
import aero.aixm.CodeICAOType;
import aero.aixm.CodeMilitaryOperationsType;
import aero.aixm.CodeOperationAirportHeliportType;
import aero.aixm.CodeStatusAirportType;
...
import aero.aixm.ValMagneticVariationChangeType;
import aero.aixm.ValMagneticVariationType;
import aero.aixm.ValTemperatureType;

public class AiportHeliportMshallerServiceTest {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
	
			String designator="ZABB";
			...
			String a=airportheliport.getMagneticVariationValue();
			...
			//	System.out.print(outString);
				...
				JMSAIXMProducer jmsAIXMProducer=new JMSAIXMProducer();
				try {
					jmsAIXMProducer.producer();
					jmsAIXMProducer.textMessageGenerate(outString);
					System.out.println("发送成功");
					jmsAIXMProducer.sendMessage();
					jmsAIXMProducer.close();
